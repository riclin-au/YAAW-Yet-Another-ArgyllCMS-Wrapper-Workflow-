...
class PrinterProfilingGUI:
    ...
    def __init__(self, root):
        self.root = root
        self.root.title("Yet Another Argyll Wrapper - build v3.40.0")
...
License: MIT
    ...
    def _step3_read_target(self, basename, settings):
        ...
        self.log(
            f"chartread launched for {basename}.  Complete the measurement in the terminal. "
            f"When {ti3_file.name} exists, run Step 4 to build the profile."
        )
        self.set_status("Step 3 launched - complete chartread in terminal")
        self.show_info(
            "chartread launched",
            "chartread has been launched in a terminal window.\n\n"
            "Complete the target reading there.  The wrapper will validate the .ti3 file when you run Step 4."
        )
        return False
    ...
    def _run_interactive_command(self, cmd, cwd=None):
        ...
        if self.open_in_terminal(title, cmd_str, cwd=cwd, hold_open=True):
            return
