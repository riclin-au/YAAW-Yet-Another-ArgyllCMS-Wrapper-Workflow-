...
class PrinterProfilingGUI:
    ...
    def __init__(self, root):
        self.root = root
        self.root.title("Yet Another Argyll Wrapper - build v3.40.3")
    ...
    def create_widgets(self):
        ...
        ttk.Button(action_frame, text="Load Config", command=self.load_config, style="YAAWHeader.TButton").pack(side='left')
 ...
 #                                  values=['CM', 'i1', '3p', 'SS', '20', '22', '41', '51'],
    ...
    def open_man_page(self, command):
        ...
        if html_page is not None:
            try:
                opened = webbrowser.open_new(html_page.as_uri())
    ...
    def create_exec_tab(self, parent):
        ...
        ttk.Button(btn_frame, text="Step 1: Generate Target", 
                   command=self.run_step1, width=25, style="YAAWAction.TButton").pack(side='left', padx=5)
        ttk.Button(btn_frame, text="Step 2: Print Target", 
                   command=self.run_step2, width=25, style="YAAWAction.TButton").pack(side='left', padx=5)
        ttk.Button(btn_frame, text="Step 3: Read Target", 
                   command=self.run_step3, width=25, style="YAAWAction.TButton").pack(side='left', padx=5)
